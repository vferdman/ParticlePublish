...
int photoresistor = A0; // This is where your photoresistor is plugged in. The other side goes to the "power" rail.
...
// interval at wich to report photoresistor value
#define REPORT_INTERVAL 1000 
int loopCount = REPORT_INTERVAL;
